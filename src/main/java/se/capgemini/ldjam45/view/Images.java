...
public enum Images {
    ...
    BACKPACK("./src/main/resources/images/items/level1/backpack.png", "Traveling alone"),
    BOOK("./src/main/resources/images/items/level1/book.png", "Reading"),
    COMPUTER("./src/main/resources/images/items/level1/computer.png", "Playing computer games"),
    JOYSTICK("./src/main/resources/images/items/level1/joystick.png", "Playing arcade games"),
    JUICE("./src/main/resources/images/items/level1/juice.png", "Drinking soda"),
    NOTEPAD("./src/main/resources/images/items/level1/notepad.png", "Writing notes"),
    REMOTE("./src/main/resources/images/items/level1/remote.png", "Playing console games"),
    SCREWDRIVER("./src/main/resources/images/items/level1/screwdriver.png", "Hack your computer"),
    SMARTPHONE("./src/main/resources/images/items/level1/smartphone.png", "Playing mobile games"),
    TOOTHBRUSH("./src/main/resources/images/items/level1/toothbrush.png", "Brushing your teeth"),
    BLENDER("./src/main/resources/images/items/level2/blender.png", "Making smoothies"),
    BRUSH("./src/main/resources/images/items/level2/brush.png", "Painting"),
    CALCULATOR("./src/main/resources/images/items/level2/calculator.png", "Math"),
    CHEMISTRY("./src/main/resources/images/items/level2/chemics.png", "Chemistry"),
    COFFEE("./src/main/resources/images/items/level2/coffee.png", "Drinking coffee"),
    HEADSET("./src/main/resources/images/items/level2/headset.png", "Listening to opera"),
    PAN("./src/main/resources/images/items/level2/pan.png","Cooking"),
    PEPPER("./src/main/resources/images/items/level2/pepper.png", "Eating spicy food"),
    WHEEL("./src/main/resources/images/items/level2/wheel.png", "Driving a car"),
    WINE("./src/main/resources/images/items/level2/wine.png", "Drinking wine"),
    BACKEND("./src/main/resources/images/items/level3/backend.png", "Backend programming"),
    BELL("./src/main/resources/images/items/level3/bell.png", "Realtime programming"),
    COLOR("./src/main/resources/images/items/level3/color.png", "Creating graphics for games"),
    FRONTEND("./src/main/resources/images/items/level3/frontend.png", "Frontend programming"),
    KEY("./src/main/resources/images/items/level3/key.png", "Cryptography"),
    KEYBOARD("./src/main/resources/images/items/level3/keyboard.png", "Typing fast on a keyboard"),
    PEN("./src/main/resources/images/items/level3/pen.png", "Writing a CV"),
    SCREEN("./src/main/resources/images/items/level3/screen.png", "Programming in Python"),
