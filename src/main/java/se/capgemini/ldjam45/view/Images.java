...
public enum Images {
    ...
    SMARTPHONE("./src/main/resources/images/items/level1/smarthphone.png"),
    TOOTHBRUSH("./src/main/resources/images/items/level1/toothbrush.png"),
    BLENDER("./src/main/resources/images/items/level1/blender.png"),
    BRUSH("./src/main/resources/images/items/level1/brush.png"),
    CALCULATOR("./src/main/resources/images/items/level1/calculator.png"),
    CHEMISTRY("./src/main/resources/images/items/level1/chemics.png"),
    COFFEE("./src/main/resources/images/items/level1/coffee.png"),
    HEADSET("./src/main/resources/images/items/level1/headset.png"),
    PAN("./src/main/resources/images/items/level1/pan.png"),
    PEPPER("./src/main/resources/images/items/level1/pepper.png"),
    WHEEL("./src/main/resources/images/items/level1/wheel.png"),
    WINE("./src/main/resources/images/items/level1/wine.png"),
    BACKEND("./src/main/resources/images/items/level1/backend.png"),
    BELL("./src/main/resources/images/items/level1/bell.png"),
    COLOR("./src/main/resources/images/items/level1/color.png"),
    FRONTEND("./src/main/resources/images/items/level1/frontend.png"),
    KEY("./src/main/resources/images/items/level1/key.png"),
    KEYBOARD("./src/main/resources/images/items/level1/keyboard.png"),
    PEN("./src/main/resources/images/items/level1/pen.png"),
    SCREEN("./src/main/resources/images/items/level1/screen.png"),
    STACK("./src/main/resources/images/items/level1/stack.png"),
    VIDEO_GAMES("./src/main/resources/images/items/level1/video_games.png");
